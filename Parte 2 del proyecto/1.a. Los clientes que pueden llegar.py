...
def main():
    ...
    for i, client in enumerate(scheduled_clients):
        print(f"Cliente {i + 1}: Tiempo de llegada: {client['arrival_time']}, Tiempo de ráfaga: {client['burst_time']}, Tipo de cliente: {client['client_type']}, Subtipo: {client['sub_type']}")
